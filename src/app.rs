                    ...
                    <section class="my-4 w-full">
                        <div class="w-full flex flex-col text-center items-center justify-center">
                            ...
                            <div class="mt-6 md:max-w-[700px] max-w-[400px] flex items-center justify-center text-center w-full">
                                <input class="bg-zinc-700 w-full py-2 px-2 rounded-md border-0 outline-none focus-0" placeholder=""/>
                            </div>
                            <div class="mt-4">
                                <div class="flex items-center gap-4">
                                    <button class="hover:bg-yellow-600 hover:border-white py-1 px-4 rounded-md border border-solid border-yellow-600 bg-black text-white translate-full delay-150">{"Search"}</button>
