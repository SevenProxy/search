...
pub fn App() -> Html {
    ...
    {
        let alert_style = "color: white; background: red; font-weight: bold; border-radius: 2px; padding: 2px 2px;";
        let discord_link_style = "color: purple; font-weight: bold;";

        console::log_2(
            &JsValue::from_str("%c[ATENÇÃOOO]%c"),
            &JsValue::from_str(alert_style),
        );
        console::log_2(
            &JsValue::from_str("%c[Entre no nosso servidor no discord]%c https://discord.gg/Kafr5x4WM5"),
            &JsValue::from_str(discord_link_style),
        );
    }
                ...
                <div class="w-full h-full flex flex-col items-center justify-center my-auto">
                    ...
                    <section class="my-4 w-full">
                        <form {onsubmit} class="w-full flex flex-col text-center items-center justify-center">
                            ...
                            <div class="mt-6 md:max-w-[700px] max-w-[400px] flex items-center justify-center text-center w-full">
                                <input type="text" value={(*search_input).clone()} {oninput} class="font-bold bg-zinc-700 w-full py-2 px-2 rounded-md border-0 outline-none focus-0" placeholder=""/>
                            </div>
                            <div class="mt-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <button class="text-white bg-purple-800 border border-solid border-purple-800 flex items-center gap-2 py-1 px-4 rounded-md">
                                        ...
                                        <a class="font-bold" href="https://discord.gg/Kafr5x4WM5">{"Discord"}</a>
                                    </button>
                                </div>
                    ...
                    <section class="mt-6">
                        <div class="w-full text-sm text-center">
                            ...
                            <a class="text-blue-500" href="https://discord.gg/Kafr5x4WM5">{"Servidor no discord"}</a>
                        </div>
                    </section>
                </div>
            </div>
